# Generated by Django 6.0.4 on 2026-04-25 21:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(choices=[('ADMIN', 'Administrador'), ('ANALISTA', 'Analista Financeiro'), ('GESTOR', 'Gestor/Diretoria')], max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_acesso', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.nivelacesso')),
            ],
            options={
                'verbose_name': 'user',
